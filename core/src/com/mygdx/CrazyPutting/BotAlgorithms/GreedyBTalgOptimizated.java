...
import com.mygdx.CrazyPutting.game.TreeSpot;

import java.util.ArrayList;

public class GreedyBTalgOptimizated implements Bot {
  private Vector2 endPos;
  private Terrain t = new Terrain();
  private ShotSimulation simulation;

  public GreedyBTalgOptimizated(int terrainNumber, ArrayList<TreeSpot> treesPos) {
